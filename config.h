...
// #define DRINK_BTNS {{0,    0,  40,   0,   140,  0,    0,    45,   49      }, \
//                     {30,  60,   0,   0,   0,    0,    0,    39,   47      }, \
//                     {40,   0,   0,   0,   0,    0,  140,    39,   49      }, \
//                     {0,    0,   0,  40,   0,  140,    0,    39,   51      }, \
//                     {40,   0,   0,   0,   0,  140,    0,    41,   47      }, \
//                     {0,    0,   0,   0,   0,   60,   60,    41,   49      }, \
//                     {10,   0,   0,   0,   0,    0,    0,    41,   51      }, \
//                     {0,   10,   0,   0,   0,    0,    0,    43,   47      }, \

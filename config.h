...
#define DRINK_BTNS {{0,    0,  40,   0,   140,  0,    0,    A0,   A4      }, \
                    {30,  60,   0,   0,   0,    0,    0,    A0,   A5      }, \
                    {40,   0,   0,   0,   0,    0,  140,    A0,   A6      }, \
                    {0,    0,   0,  40,   0,  140,    0,    A1,   A4      }, \
                    {40,   0,   0,   0,   0,  140,    0,    A1,   A5      }, \
                    {0,    0,   0,   0,   0,   60,   60,    A1,   A6      }, \
                    {10,   0,   0,   0,   0,    0,    0,    A2,   A4      }, \
                    {0,   10,   0,   0,   0,    0,    0,    A2,   A5      }, \
